angular.module('MyApp')
       .factory('AppUserService', ['$q', '$http', function ($q, $http) {
           ...
           appuserService.selecteduser = {};
           
           // Get All Users
           appuserService.getAllUsers = function () {
               var deferred = $q.defer();
               return $http.get("http://localhost/vdo.server/api/appuser")
                    .success(function (data) {
                        deferred.resolve(
                            appuserService.appusers = data);
                    })
           ...
           // Search Customers
           appuserService.search = function (text) {
               var deferred = $q.defer();
               return $http({
                   url: baseUrl + 'search',
                   method: 'GET',
